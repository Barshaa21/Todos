  ...
  const addTodo = (title, desc, id) => {
    if (con.id != null) {
      setTodos(
        todos.map((todo) => {
          if (todo.id === con.id) {
            return { ...todo, title: con.title, desc: con.desc, id: con.id };
          }
          return todo;
        })
      );
          ...
          <>
            ...
            <div className="div" style={{ color: "white", paddingTop: "20px" }}>
              <form onSubmit={submit}>
                <div
                  className="container mb-3 border border-dark"
                  style={{
                    width: "550px",
                    height: "100px",
                ...
                <div
                  className="mb-3 container border border-dark "
                  style={{
                    width: "550px",
                    height: "100px",
                    backgroundColor: "black",
                ...
                >
                  ...
                  <input
                    type="text"
                    value={con.desc}
                    onChange={(e) => setCon({ ...con, desc: e.target.value })}
                    className="form-control"
                  />
                </div>
                <button
                ...
                >
                  <span className="bi bi-trash"></span>Add todo
                </button>
              </form>
            </div>
            <Todos
